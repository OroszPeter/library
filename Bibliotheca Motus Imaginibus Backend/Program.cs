...
{
    options.Password.RequireDigit = false; // Nem k�telez� sz�mjegy
    options.Password.RequireLowercase = false; // Nem k�telez� kisbet�
    options.Password.RequireUppercase = false; // Nem k�telez� nagybet�
    options.Password.RequireNonAlphanumeric = false; // Nem k�telez� k�l�nleges karakter
    options.Password.RequiredLength = 8; // Minim�lis jelsz�hossz (pl.: 6 karakter)
    options.Password.RequiredUniqueChars = 0; // Minim�lis egyedi karakterek sz�ma
})
...
builder.Services.AddCors(option =>
{
    ...
    {
        policyBuilder
            .AllowAnyOrigin()  // B�rmilyen forr�st enged�lyez
            .AllowAnyHeader()
            .AllowAnyMethod();
    });
});
